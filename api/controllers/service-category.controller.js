...
exports.findAll = (req, res) => {
  ...
  var query = fs.readFileSync(path.join(__dirname, queryPath, 'GET/get_service_category.sql')).toString() +
  ` ORDER BY name ASC;`;
...
exports.findRelatedWebsites = (req, res) => {
  var query = fs.readFileSync(path.join(__dirname, queryPath, 'GET/get_service_category_related_websites.sql')).toString() +
