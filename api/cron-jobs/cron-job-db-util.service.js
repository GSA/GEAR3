import { prepareQuery, runQuery } from "../util/db-query-service";
 ...
 */
export const getAnyPendingJob = async (jobType) => {
 ...
 */
export const insertDbData = async (rowData) => {
 ...
 */
export const updateDbData = async (rowData) => {
