...
export class WebsitesManagerComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe(params => {
      ...
      this.apiService.getOneWebsite(this.websiteId).subscribe(web => {
        ...
        this.previousRouteService.setCurrentPageTitle(web.domain);
  ...
  setFormDefaults(): void {
    ...
    this.apiService.getWebsiteSys(this.websiteId).subscribe((data: any[]) => {
  ...
  submitForm() {
    ...
    if (this.websiteForm.valid) {
      ...
      this.apiService.updateWebsiteSys(this.websiteId, this.websiteForm.value).toPromise()
        .then(res => {
          // Grab new data from database
          this.apiService.getOneWebsite(this.websiteId).toPromise()
            .then(),
            (error) => {
