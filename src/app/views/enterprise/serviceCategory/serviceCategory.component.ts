...
export class ServiceCategoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    $('#serviceCategoryTable').bootstrapTable($.extend(this.tableOptions, {
    ...
    $(document).ready(
      $('#serviceCategoryTable').on('click-row.bs.table', function (e, row) {
      ...
      this.route.params.subscribe(params => {
        ...
        if (detailServiceCategoryID) {
          this.apiService.getOneServiceCategory(detailServiceCategoryID).subscribe((data: any[]) => {
