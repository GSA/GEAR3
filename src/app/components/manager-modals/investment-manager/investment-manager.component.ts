      ...
      this.apiService.getApplications().toPromise()
        .then((data: any[]) => {
          ...
          this.investForm.patchValue({
            ...
            invManager: this.sharedService.findInArray(this.managers, 'Name', this.investment.InvManager, 'SamAccountName'),
            investType: this.sharedService.findInArray(this.types, 'Name', this.investment.Type, 'ID'),
            investBY: this.investment.Budget_Year,
            investUII: this.investment.UII,
            investSSO: this.sharedService.findInArray(this.SSOs, 'Name', this.investment.SSO, 'ID'),
            investPSA: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.PSA, 'ID'),
            investSSA: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.SSA, 'ID'),
            // investSSA2: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.sec_service_area2, 'ID'),
            // investSSA3: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.sec_service_area3, 'ID'),
            // investSSA4: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.sec_service_area4, 'ID'),
