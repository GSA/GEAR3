      ...
      this.apiService.getApplications().toPromise()
        .then((data: any[]) => {
          ...
          this.investForm.patchValue({
            ...
            investType: this.sharedService.findInArray(this.types, 'Name', this.investment.Type),
            investBY: this.investment.Budget_Year,
            investUII: this.investment.UII,
            investSSO: this.sharedService.findInArray(this.SSOs, 'Name', this.investment.SSO),
            investPSA: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.PSA),
            investSSA: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.SSA),
            // investSSA2: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.sec_service_area2),
            // investSSA3: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.sec_service_area3),
            // investSSA4: this.sharedService.findInArray(this.serviceAreas, 'Name', this.investment.sec_service_area4),
