...
export class ItStandardManagerComponent implements OnInit {
  ...
  setFormDefaults(): void {
    ...
    if (this.createBool) {
      ...
      this.itStandardsForm.patchValue({
        itStandStatus: this.sharedService.findInArray(this.statuses, 'Name', this.itStandard.Status, 'ID'),
        itStandName: this.itStandard.Name,
        itStandPOC: pocIDs,
        itStandDesc: this.itStandard.Description,
        itStandType: this.sharedService.findInArray(this.types, 'Name', this.itStandard.StandardType, 'ID'),
        itStandCategory: categoryIDs,
        itStand508: this.sharedService.findInArray(this.compliance, 'Name', this.itStandard.ComplianceStatus, 'ID'),
        itStandMyView: myView,
        itStandVendorOrg: this.itStandard.Vendor_Standard_Organization,
        itStandDeployment: this.sharedService.findInArray(this.deploymentTypes, 'Name', this.itStandard.DeploymentType, 'ID'),
