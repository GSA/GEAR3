...
export class OrganizationsModalComponent implements OnInit {
  ...
  // Organizational Apps Table Options
  tableOptions: {} = {
    advancedSearch: true,
    idTable: 'advSearchOrgAppsTable',
    buttonsClass: 'info',
    cache: true,
  ...
  // Organizational Apps Table Columns
  columnDefs: any[] = [{
    field: 'Name',
  ...
  ngOnInit(): void {
    ...
    $('#orgAppsTable').bootstrapTable($.extend(this.tableOptions, {
    ...
    //     console.log("Organizational Apps Clicked Row: ", row);  // Debug
