...
import { FontAwesomeConfigModule } from './fontawesome/fontawesome-config.module';
...
@NgModule({
  ...
  providers: [provideClientHydration(), Globals, provideHttpClient(withInterceptorsFromDi(), withFetch())]
})
